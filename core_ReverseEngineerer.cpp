...
ReverseEngineerer::ReverseEngineerer(bool c, DatabaseEngine* engine, Project* p, const QString &host, const QString &user, const QString &pass, const QString &db, const QStringList& tabsToReverse, const QStringList& viewsToReverse, QObject *parent):
...
{
    ReverseEngineererThread* genThread = new ReverseEngineererThread(m_createDataTypesForColumns, m_engine, m_project, m_host, m_user, m_pass, m_db, m_tabsToReverse, m_viewsToReverse);
