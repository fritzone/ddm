...
Index::Index(Table* tab) : m_owner(tab), m_name(""), m_type(""), m_columns()
{
}

Index::Index(const QString &name, const QString &type, Table* tab) : m_owner(tab), m_name(name), m_type(type), m_columns()
{
}
