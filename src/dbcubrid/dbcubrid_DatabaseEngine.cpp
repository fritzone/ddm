...
QString CUBRIDDatabaseEngine::getDefaultDatatypesLocation()
{
    return "CUBRID.defaults";
}
...
QStringList CUBRIDDatabaseEngine::getIndexTypes()
{
    return m_indexTypes;
}

QString CUBRIDDatabaseEngine::getDelimiterKeyword()
{
    return "delimiter";
}

QStringList CUBRIDDatabaseEngine::getTriggerEvents()
{
    QStringList result;
...
QStringList CUBRIDDatabaseEngine::getTriggerTimings()
{
    QStringList result;
    result << "BEFORE" << "AFTER";
    return result;
...
QStringList CUBRIDDatabaseEngine::getCodepageList()
{
...
QStringList CUBRIDDatabaseEngine::getKeywords() const
{
...
QStringList CUBRIDDatabaseEngine::getSupportedStorageEngines(const QString& host, const QString& user, const QString& pass, int port)
{
    CUBRIDConnection *c = new CUBRIDConnection("temp", host, user, pass, "", false, false, port);
    QSqlDatabase db = getQSqlDatabaseForConnection(c);
    bool ok = db.isOpen();
    QStringList result;
