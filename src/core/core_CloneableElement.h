...
/**
 * All the objects that can be cloned (ie: create an identical copy, with a
 * different GUID) must derive from this. This class maintains a link to the
 * "source" via the UID of it, in order for the version comparer to know
