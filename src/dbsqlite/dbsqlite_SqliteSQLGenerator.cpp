...
QString SqliteSQLGenerator::quotelessString(const QString& in) const
{
    QString result = "";
...
QStringList SqliteSQLGenerator::generateDefaultValuesSql(TableInstance* tableInstance, const QHash<QString, QString>& options) const
{
    QStringList result;
    int maxValues = 0;
...
QStringList SqliteSQLGenerator::generateDefaultValuesSql(Table* table, const QHash<QString, QString>& options) const
{
    QStringList result;
...
QStringList SqliteSQLGenerator::generateCreateViewSql(View *v, const QHash<QString, QString> &/*options*/) const
{
    if(v->isManual())
    {
        QStringList res;
...
QStringList SqliteSQLGenerator::generateTriggerSql(Trigger* t, const QHash<QString, QString>& options) const
{
    QStringList result;
    bool upcase = options.contains("Case") && options["Case"] == "Upper";
...
QString SqliteSQLGenerator::sqlForAColumn(const Column *col, int pkpos, bool backticks, bool upcase) const
{
    QString createTable = " ";
