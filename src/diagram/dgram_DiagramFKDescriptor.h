...
public:
    ...
    DiagramFKDescriptor(const QString& txt, const QString& txt_2, int x, int y, const QString& fkn, Version *v) : DiagramObjectDescriptor(txt, x, y, v), fkName(fkn), m_txt2(txt_2)
    {}
    ...
    DiagramFKDescriptor(const QString &txt, const QString &txt_2, int x, int y, qreal ellx, qreal elly, qreal l1otx, qreal l1oty, qreal l1posx,
                        ...
                        qreal arrowp1x, qreal arrowp1y, qreal arrowp2x, qreal arrowp2y, qreal arrowposx, qreal arrowposy, const QString& fkn, Version *v) :
                    DiagramObjectDescriptor(txt, x, y, v),
